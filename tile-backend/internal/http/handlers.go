...
func NewTemplateHandler(store store.Store, logger *zap.Logger) *TemplateHandler {
...
func (h *TemplateHandler) GeneratePlatform(w http.ResponseWriter, r *http.Request) {
	var req generate.PlatformGenerateRequest
